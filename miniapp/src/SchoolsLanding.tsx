    ...
    <div className="lp">
      ...
      <section className="lp-section">
        <div className="lp-container">
          <h2 className="lp-h2">Почему нужен AI-репетитор?</h2>
          <div className="sch-grid3">
            <SchCard
              title="Никто не тренирует разговорный английский дома"
              body="Говорить дома не с кем, а на уроке в группе на каждого ученика приходится пара минут живой речи. Язык не практикуется."
            />
            <SchCard
              title="Прогресс между уроками не виден"
              body="«Занимался?» — «Да». Проверять некогда. Преподаватель узнаёт о пробелах только на занятии."
            />
            <SchCard
              title="Ученики уходят, не увидев результата"
              body="Без ощущения прогресса мотивация падает, и через пару месяцев человек бросает обучение, не продлевает абонемент."
            />
          </div>
        </div>
      </section>
      ...
      <section className="lp-section">
        <div className="lp-container">
          ...
          <div className="sch-steps">
            {[
              { n: "1", t: "Вы оплачиваете школьный пакет", d: "Выбираете количество учеников и срок прямо здесь, платите картой. Чек приходит на почту." },
      ...
      <section className="lp-section sch-money" id="money">
        <div className="lp-container">
          ...
          <p className="lp-section__sub" style={{ maxWidth: 720 }}>
            ...
            абонементу, за которую покупатели платят охотно: учащийся, наконец,
          ...
          <div className="sch-money__calc">
            <div className="sch-money__controls">
              ...
              <div className="sch-money__rows">
                ...
                <div className="sch-money__row">
                  <span>Оплачивается учеником</span>
                  <b>{fmt(studentPrice)} ₽ / мес</b>
                </div>
                <div className="sch-money__row sch-money__row--accent">
                  <span>Ваш дополнительный доход с ученика</span>
                  <b>
            ...
            <div className="sch-way">
              ...
              <div>
                ...
                <div className="sch-way__body">
                  ...
                  У заказчика появляется понятная причина повышения тарифа,
            ...
            <div className="sch-way">
              ...
              <div>
                ...
                <div className="sch-way__body">
                  ...
                  сохранённый абонемент обычно дороже, чем AI-репетитор на всю группу.
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="lp-section">
        <div className="lp-container">
          ...
          <div className="sch-grid3">
            ...
            <SchCard title="Без рекламы вашим ученикам" body="Ученикам школы сервис не предлагает купить личную подписку и не шлёт рекламных рассылок." />
          </div>
        </div>
      </section>
      ...
      <section className="lp-section">
        <div className="lp-container">
          ...
          <div className="sch-faq">
            ...
            <SchFaq q="Нужны закрывающие документы?" a="При оплате картой чек по 54-ФЗ приходит на email автоматически. Если нужен счёт и договор на юрлицо — нажмите «Нужен счёт для юрлица» под калькулятором, пришлём документы." />
