...
Форма: I/you/we/they + глагол; he/she/it + глагол-s. Вопросы и отрицания через do/does: Do you…? She doesn't…
...
Форма: am/is/are + глагол-ing: She is working. They are watching TV.
...
She is the most talented person here. — Она самый талантливый человек здесь.""",
    ...
    "b1_present_perfect_vs_past": """Present Perfect (have/has + V3) — результат к настоящему моменту, время не указано: I have lost my keys (ключей нет СЕЙЧАС).
...
He worked there in 2019. — Он работал там в 2019-м.""",
    ...
    "b1_past_continuous": """Past Continuous (was/were + V-ing) — процесс в конкретный момент прошлого: At 8 pm I was having dinner (в 8 я ужинал — процесс).
...
Формула: be (в нужном времени) + V3: is made, was sent, will be done.
...
The plane took off on time. — Самолёт взлетел вовремя.""",
    ...
    "b2_present_perfect_cont": """Present Perfect Continuous (have/has been + V-ing) — действие началось в прошлом и ДЛИТСЯ до сих пор, акцент на процессе и длительности: I have been waiting for an hour (жду уже час).
...
Тип 2 (настоящее → прошлое): If + Past Simple, would have + V3: If I were braver, I would have asked her out (я в принципе не смелый — поэтому тогда не позвал).
...
I wish I were taller. — Жаль, что я не выше ростом.""",
    ...
    "b2_modals_deduction": """Модальные глаголы дедукции о ПРОШЛОМ: modal + have + V3.
...
Отдельная ловушка: needn't have + V3 = сделал зря (You needn't have cooked — we ate out. Зря готовил).
...
Have + объект + V3: I had the house painted (мне покрасили дом). Get — разговорнее: I got my phone fixed.
